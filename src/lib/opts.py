...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='coco',
                             help='coco | kitti | coco_hp | pascal | dac')
    ...
    self.parser.add_argument('--save_image', action='store_false')
    ...
    self.parser.add_argument('--vis_thresh', type=float, default=0.15,
  ...
  def init(self, args=''):
    default_dataset_info = {
      'ctdet': {'default_resolution': [512, 512], 'num_classes': 96,
                'mean': [0.44387722, 0.45443517, 0.41266478],
                'std': [0.2316625934896425, 0.21541203506039922, 0.24325553952463594],
                'dataset': 'coco'},
